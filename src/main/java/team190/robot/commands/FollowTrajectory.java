...
import team190.models.SrxMotionProfile;
import team190.models.SrxTrajectory;
import team190.robot.Robot;
import team190.util.SrxTrajectoryImporter;
...
public class FollowTrajectory extends Command {
    ...
    private class PeriodicRunnable implements java.lang.Runnable {
        public void run() {
            Robot.drivetrain.leftPair.processMotionProfileBuffer();
            Robot.drivetrain.rightPair.processMotionProfileBuffer();
        }
    }
    ...
    protected void initialize() {
        ...
        setUpTalon(Robot.drivetrain.rightPair);
        setUpTalon(Robot.drivetrain.leftPair);

        setValue = SetValueMotionProfile.Disable;

        Robot.drivetrain.leftPair.set(ControlMode.MotionProfile, setValue.value);
        Robot.drivetrain.rightPair.set(ControlMode.MotionProfile, setValue.value);
        ...
        fillTalonBuffer(Robot.drivetrain.rightPair, this.traj.rightProfile, pidfSlot);
        fillTalonBuffer(Robot.drivetrain.leftPair, this.traj.leftProfile, pidfSlot);
    ...
    protected void end() {
        SrxNotifier.stop();
        resetTalon(Robot.drivetrain.rightPair, ControlMode.PercentOutput, 0);
        resetTalon(Robot.drivetrain.leftPair, ControlMode.PercentOutput, 0);
    }
